# Generated by Django 4.1.7 on 2024-11-09 13:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preview_description', models.CharField(blank=True, max_length=100, null=True, verbose_name='Preview Description For Course List Page')),
                ...
                ('language', models.CharField(choices=[('EN', 'English'), ('RU', 'Russian')], default='EN', max_length=2, verbose_name='Язык')),
                ('skill_level', models.CharField(choices=[('ALL', 'All Levels'), ('BEGINNER', 'Beginner'), ('INTERMEDIATE', 'Intermediate'), ('ADVANCED', 'Advanced')], default='ALL', max_length=12, verbose_name='Skill Level')),
        ...
        migrations.AddField(
            model_name='test',
            name='test_module',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tests', to='webapp.testmodule', verbose_name='Тестовый модуль'),
        ),
        migrations.CreateModel(
            name='Skills',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, verbose_name='Скилл на русском')),
